...
def print_running_environment( demux ):
    ...
    demuxLogger.info( termcolor.colored( f"\tclear; rm -rvf /data/" + "{" + f"{constants.DEMULTIPLEX_DIR_NAME},{constants.FOR_TRANSFER_DIR_NAME}" + "}" + f"/{demux.RunID}* " + f"&&  /data/bin/demultiplex.py {demux.RunID}\n\n", attrs=["bold"] ) )
